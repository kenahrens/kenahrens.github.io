...
![Kibana Speedscale Traffic dashboard showing request rate by service, latency percentiles, and status distribution](./elasticsearch-dashboard.png)
...
![Kibana Discover view filtered to outerspace-server showing individual RRPair documents with 500 status codes](./elasticsearch-kibana.png)
...
![Cursor IDE with AI agent analyzing the proxymock snapshot — flagging the DEL control character bug on /api/rocket](./cursor.png)
...
![proxymock replay report showing 118 requests, 100% match rate, validations passed](./proxymock-web.png)
