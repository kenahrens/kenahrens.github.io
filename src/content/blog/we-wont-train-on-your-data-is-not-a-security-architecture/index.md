...
![What you're actually trusting when you sign the MSA clause](./msa-trust-chain.svg)
...
![30 EU/EEA countries each enacted their own national data protection law on top of GDPR](./eu-regulation-grid.svg)
...
![BYOC architecture: capture, DLP, storage, and replay all inside your VPC](./byoc-architecture.svg)
